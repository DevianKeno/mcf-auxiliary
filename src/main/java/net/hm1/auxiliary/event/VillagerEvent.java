...
import net.hm1.auxiliary.registry.Villagers;
...
public class VillagerEvent
{
    ...
    {
        if (event.getType() == Villagers.GUNSMITH.get())
        {
    ...
    static void addGunsmithTrades(VillagerTradesEvent event)
    {
        ...
        {
            new MerchantOffer(
                item(net.minecraft.world.item.Items.GUNPOWDER, 3),
                item(net.minecraft.world.item.Items.EMERALD, 1),
                16, 2, 0.05f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.COAL, 16),
                item(net.minecraft.world.item.Items.EMERALD, 1),
                16, 2, 0.05f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.getGunPrice(HANDGUN)),
        ...
        final MerchantOffer[] APPRENTICE_TRADES =
        {
            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, 1),
                item(net.minecraft.world.item.Items.GUNPOWDER, 2),
                12, 5, 0.02f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, 1),
                item(net.minecraft.world.item.Items.COAL, 1),
                12, 5, 0.02f),
        };
        ...
        final MerchantOffer[] JOURNEYMAN_TRADES =
        {
            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, 1),
                item(net.minecraft.world.item.Items.STONE, 4), /// THIS SHOULD BE LIMESTONE T-T
                12, 8, 0.05f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.getGunPrice(ASSAULT_RIFLE)),
        ...
        {
            new MerchantOffer(
                item(Items.GUN_SCHEMATIC.get(), 1),
                item(net.minecraft.world.item.Items.GUNPOWDER, 2),
                16, 10, 0.05f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.getGunPrice(SNIPER_RIFLE)),
        ...
        final MerchantOffer[] MASTER_TRADES =
        {
            ...
            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, 50),
                item(Utils.item("create:precision_mechanism"), 1),
                4, 10, 0.02f),

            new MerchantOffer(
                item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.getGunPrice(MACHINE_GUN)),
        ...
        trades.get(2).add((pTrader, pRandom) ->
        {
            ...
            if (pRandom.nextBoolean()) {
                selectedTrades.add(new MerchantOffer(
                    item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.GUNTYPE_SCHEMATIC_PRICES.get(SHOTGUN).get()),
                    item(GunSchematic.ofRandom(SHOTGUN).getItem(), 1),
                    1, 8, 0.02f));
            } else {
                selectedTrades.add(new MerchantOffer(
                    item(net.minecraft.world.item.Items.EMERALD, AuxiliaryConfig.GUNTYPE_SCHEMATIC_PRICES.get(SUBMACHINE_GUN).get()),
